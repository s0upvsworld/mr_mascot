...
class MrMascotAI:
    def __init__(self, summary, game_date, gameHighlights, ballpark, winning_team, series_status):
        self.prompt = Prompts(summary, game_date, gameHighlights, ballpark, winning_team, series_status)
...
if __name__ == '__main__':
    ...
    ballpark = 'Citifield'
    start = MrMascotAI(summary, game_date, gameHighlights, ballpark, winning_team, series_status)
